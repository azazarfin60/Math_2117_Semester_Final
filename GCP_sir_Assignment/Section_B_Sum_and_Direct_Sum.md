...
## Q14 (04)
**Question:** **Let $U = \text{span}\{(1, 0, 0), (0, 1, 0)\}$, $W = \text{span}\{(0, 0, 1)\}$. Show that $\mathbb{R}^3 = U \oplus W$.**
...
**Answer:**
Consider the vector space $V = \mathbb{R}^2$. Let $U = \text{span}\{(1, 0)\}$ and $W = \text{span}\{(1, 0), (0, 1)\}$. Here, $U$ is the x-axis, and $W$ is the entire $\mathbb{R}^2$ plane.
