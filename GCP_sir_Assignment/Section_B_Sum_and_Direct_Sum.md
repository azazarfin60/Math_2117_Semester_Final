...
## Q14 (04)
**Question:** **Let $U = \text{span}\lbrace(1, 0, 0), (0, 1, 0)\rbrace$, $W = \text{span}\lbrace(0, 0, 1)\rbrace$. Show that $\mathbb{R}^3 = U \oplus W$.**

**Answer:**
To show $\mathbb{R}^3 = U \oplus W$, we must prove that $\mathbb{R}^3 = U + W$ and $U \cap W = \lbrace 0\rbrace$.
...
**Answer:**
Consider the vector space $V = \mathbb{R}^2$. Let $U = \text{span}\lbrace(1, 0)\rbrace$ and $W = \text{span}\lbrace(1, 0), (0, 1)\rbrace$. Here, $U$ is the x-axis, and $W$ is the entire $\mathbb{R}^2$ plane.
