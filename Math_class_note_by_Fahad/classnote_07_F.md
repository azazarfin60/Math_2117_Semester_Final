...
then $\begin{bmatrix} 1 \\ 1 \end{bmatrix}$ is an eigen vector associated with the eigen value $\lambda = 5$.
...
$$\text{or, } \left. \begin{matrix} v_1 - v_2 = 0 \\ v_1 - v_2 = 0 \end{matrix} \right\} \sim v_1 - v_2 = 0$$
...
$$\Rightarrow |A - \lambda I| = (1-\lambda) \{ (2-\lambda)^2 - 4 \} - 2 \{ -1(2-\lambda) - 4 \} + 3 \{ -1 - 1(2-\lambda) \}$$
$$= (1-\lambda)(4 - 4\lambda + \lambda^2 - 4) - 2 \{ \lambda - 2 - 4 \} + 3 \{ -1 - 2 + \lambda \}$$
...
$$\mathbb{R}^n = \{ (a_1, a_2, a_3 \dots a_n) \mid a_1, a_2, a_3 \dots a_n \in \mathbb{R} \}$$
...
$\star$ **$\begin{bmatrix} 1 & 2 \\ 2 & 1 \end{bmatrix}$ vectors থেকে $(4, 5)$ নির্ণয়।**
