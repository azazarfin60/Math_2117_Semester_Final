...
$\mathbb{R}^3$ এর জন্য $\{ v\_1, v\_2, v\_3, v\_4 \} \rightarrow$ minimum 3টি
$$\{ v\_1 = (1,0,0) \ ; \ v\_2 = (0,1,0) \ ; \ v\_3 = (0,0,1) \} \rightarrow \text{minimum spanning set.}$$
...
$$\text{Standard basis } \{ u\_1 = (1,0,0) \ ; \ u\_2 = (0,1,0) \ ; \ u\_3 = (0,0,1) \}$$
4টি থাকলে basis হবে না।
যতগুলো independent vector থাকবে সেগুলো dimention.

### Sum and direct sum:-
$$w, u$$
$$w+u = \{ v = u+w : u \in U, w \in W \}$$
