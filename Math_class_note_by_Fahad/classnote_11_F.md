...
```
     ...
     +-----------------+              +-----------------+
```
- $\{ w\_1, w\_2, w\_3, w\_4 \} \rightarrow \text{Im}(T) \rightarrow \text{image of the mapping.}$
...
$$\text{ker}(T) = \{ u \mid u \rightarrow 0 \}$$
...
$$\{ (1,0,0) , (0,1,0) , (0,0,1) \} \text{ that generates } \mathbb{R}^3.$$

Then the basis $\{ T(1,0,0) , T(0,1,0) , T(0,0,1) \}$ will generate the Im $T$.
...
We see there are 2 independent vectors $(1,0,1)$ and $(0,-1,2)$ and hence $\{ (1,0,1) , (0,-1,2) \}$ is a basis of Im $T$.
...
$$T(x,y) = (5x+y , -4x+3y).$$
Find the matrix representation of $T$ with respect to the basis $\{ u\_1 = (3,1) \ ; \ v\_2 = (5,2) \}$.
...
Fourier basis $\{ 1, \sin x, \cos x, \sin 2x, \cos 2x \dots \}$
**এগুলো orthogonal vector.**
**এই সবগুলোর মধ্যবর্তী Angle $90^\circ$.**
$$\langle 1, \sin x \rangle = 0$$

$\star$ **Show that $\{ (1,0,0), (0,1,0), (0,0,1) \}$ forms an orthogonal basis of $\mathbb{R}^3$.**
