...
Write the vector $v = (1, -2, 5)$ as a linear combination of the vectors $e\_1 = (1, 1, 1)$, $e\_2 = (1, 2, 3)$ and $e\_3 = (2, -1, 1)$.
...
Consider the vectors $v\_1 = (2, 1, 4), v\_2 = (1, -1, 3)$ and $v\_3 = (3, 2, 5)$ in $\mathbb{R}^3$. Show that $v = (5, 9, 5)$ is a linear combination of $v\_1, v\_2$, and $v\_3$.
...
Express the polynomial $v = 3t^2 + 5t - 5$ as a linear combination of the polynomials $P\_1 = t^2 + 2t + 1$, $P\_2 = 2t^2 + 5t + 4$ and $P\_3 = t^2 + 3t + 6$.
