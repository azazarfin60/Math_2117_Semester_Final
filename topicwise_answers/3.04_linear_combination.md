...
Write the vector $v = (1, -2, 5)$ as a linear combination of $e_1 = (1, 1, 1)$, $e_2 = (1, 2, 3)$, and $e_3 = (2, -1, 1)$.
...
Consider the vectors $v_1 = (2, 1, 4)$, $v_2 = (1, -1, 3)$, and $v_3 = (3, 2, 5)$ in $\mathbb{R}^3$. Show that $v = (5, 9, 5)$ is a linear combination of $v_1, v_2$, and $v_3$.
...
* From row 2: $3c_2 - 1 = -13 \implies c_2 = -4$.

* From row 1: $c_1 - (-4) + 2(1) = 9 \implies c_1 = 3$.
...
Express the polynomial $v = 3t^2 + 5t - 5$ as a linear combination of $P_1 = t^2 + 2t + 1$, $P_2 = 2t^2 + 5t + 4$, and $P_3 = t^2 + 3t + 6$.
