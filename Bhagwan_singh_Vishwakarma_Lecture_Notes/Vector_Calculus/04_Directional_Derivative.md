# Lecture 04: Concept of Directional Derivative
...
- $\hat{a} = \frac{\vec{a}}{|\vec{a}|}$ is the unit vector in the direction of vector $\vec{a}$.

Because the dot product yields a scalar, the directional derivative is a scalar magnitude.

### Maximum Directional Derivative
The dot product $\hat{a} \cdot \nabla\phi$ equals $|\nabla\phi| \cos\theta$. This value is maximized when $\cos\theta = 1$, which occurs when $\theta = 0$.
...
$$
\vec{n}_1 = 4\hat{i} - 2\hat{j} + 4\hat{k} \quad \implies |\vec{n}_1| = \sqrt{16+4+16} = 6
$$
$$
\vec{n}_2 = 4\hat{i} - 2\hat{j} - \hat{k} \quad \implies |\vec{n}_2| = \sqrt{16+4+1} = \sqrt{21}
$$
Use the dot product formula $\cos\theta = \frac{\vec{n}_1 \cdot \vec{n}_2}{|\vec{n}_1||\vec{n}_2|}$ to find the angle:
$$
...
1. In what direction from the point $(2, 1, -1)$ is the directional derivative of $\phi = x^2 yz^3$ maximum, and what is its magnitude?
   - **Answer**: Maximum in direction of $-4\hat{i} - 4\hat{j} + 12\hat{k}$ with magnitude $4\sqrt{11}$.
2. Find the maximum value of the directional derivative of $\phi = 2x^2 + 3y^2 + 5z^2$ at the point $(1, 1, -4)$.
   - **Answer**: $2\sqrt{413}$.
3. Find the directional derivative of $\phi = x^2 - 2y^2 + 4z^2$ at the point $(1, 1, -1)$ in the direction $2\hat{i} + \hat{j} - \hat{k}$. In what direction is the directional derivative of $\phi$ at $(1, 1, -1)$ maximum, and what is its value?
   - **Answer**: Directional Derivative: $\frac{4\sqrt{6}}{3}$. Maximum direction: $2\hat{i} - 4\hat{j} - 8\hat{k}$. Maximum value: $2\sqrt{21}$.
