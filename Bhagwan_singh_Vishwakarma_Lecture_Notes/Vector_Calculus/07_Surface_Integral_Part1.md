# Lecture 07: Concept of Surface and Volume Integral (Part 1)
...
Possible forms of volume integrals include:
...
$$
\hat{\mathbf{n}} = \frac{\nabla \phi}{|\nabla \phi|} = \frac{1}{7}(2\hat{\mathbf{i}} + 3\hat{\mathbf{j}} + 6\hat{\mathbf{k}})
$$
