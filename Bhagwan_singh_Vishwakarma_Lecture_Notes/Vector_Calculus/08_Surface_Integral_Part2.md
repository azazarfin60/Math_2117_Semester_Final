# Lecture 08: Concept of Surface and Volume Integral (Part 2)
...
### Problem 1 (Revisited): Projection on the $yz$-plane
...
$$
$$
= \int_0^4 \left[ 3z^2 - 6z + 3yz \right]_0^{2-y/2} \, dy
$$
$$
= \int_0^4 \left\{ 3\left(2 - \frac{y}{2}\right)^2 - 6\left(2 - \frac{y}{2}\right) + 3y\left(2 - \frac{y}{2}\right) \right\} \, dy
$$
$$
= \int_0^4 \left\{ 3\left(4 + \frac{y^2}{4} - 2y\right) - 12 + 3y + 6y - \frac{3y^2}{2} \right\} \, dy
$$
$$
= \int_0^4 \left( 12 + \frac{3}{4}y^2 - 6y - 12 + 9y - \frac{3y^2}{2} \right) \, dy
$$
$$
= \int_0^4 \left( 3y - \frac{3y^2}{4} \right) \, dy
$$
$$
= 3\left[ \frac{y^2}{2} \right]_0^4 - \frac{3}{4}\left[ \frac{y^3}{3} \right]_0^4 = \frac{48}{2} - 16 = 24 - 16 = 8
$$
The answer is identical to the $xy$-plane projection.
...
**Solution:**
Let $f = x^2 + y^2 + z^2 - 1$. The gradient is:
$$
\nabla f = 2x\hat{\mathbf{i}} + 2y\hat{\mathbf{j}} + 2z\hat{\mathbf{k}}
$$
The magnitude is $|\nabla f| = \sqrt{4(x^2 + y^2 + z^2)} = \sqrt{4(1)} = 2$.
...
#### Method 1: Cartesian Projection (on $xy$-plane)
Project the sphere onto the $xy$-plane. The projection is a quarter circle bounded by $x^2 + y^2 = 1$.
- $x$ varies from $0$ to $1$.
- $y$ varies from $0$ to $\sqrt{1 - x^2}$.

The area element is $dS = \frac{dx \, dy}{|\hat{\mathbf{n}} \cdot \hat{\mathbf{k}}|}$. Since $\hat{\mathbf{n}} \cdot \hat{\mathbf{k}} = z$, we have $dS = \frac{dx \, dy}{z}$.
