...
. Since this is built only from $\beta$ vectors, $w \in W$.
So,
...
$$
S_1 = \lbrace (1, 1, 0, -1), (1, 2, 3, 0), (2, 3, 3, -1) \rbrace
$$

$W_2$ is generated by

$$
S_2 = \lbrace (1, 2, 2, -2), (2, 3, 2, -3), (1, 3, 4, -3) \rbrace
$$
...
1 & 2 & 3 & 0 \\
2 & 3 & 3 & -1
\end{bmatrix} \to \begin{bmatrix} 1 & 1 & 0 & -1 \\ 0 & 1 & 3 & 1 \\ 0 & 0 & 0 & 0 \end{bmatrix}
$$

Since there are 2 non-zero rows, Rank($A$) = 2. Thus,
...
2 & 3 & 2 & -3 \\
1 & 3 & 4 & -3
\end{bmatrix} \to \begin{bmatrix} 1 & 2 & 2 & -2 \\ 0 & -1 & -2 & 1 \\ 0 & 0 & 0 & 0 \end{bmatrix}
$$
