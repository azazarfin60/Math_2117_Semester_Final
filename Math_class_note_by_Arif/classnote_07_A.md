...
is called a linear combination, where
...
$$
(100, 200) = 100(1, 0) + 200(0, 1) = 100e_1 + 200e_2
$$

| $(3, 2) \in \mathbb{R}^2$ <br> $(3, 2) = 1(1, 0) + 1(2, 0) + 1(0, 2)$ |
...
c_1 + 3c_2 &= 0 \\
2c_1 + 2c_2 &= 0
\end{aligned} \right\rbrace \Rightarrow \begin{aligned} c_1 &= 0 \\ c_2 &= 0 \end{aligned}
$$
...
$$
\lbrace v_1 = (1,0,0), v_2 = (0,1,0), v_3 = (0,0,1)\rbrace
$$

$\rightarrow$ usual / standard basis (৩টি).
...
is defined as $f(x, y, z) = (x, y, 0)$ (projection onto $xy$-plane). Show that it is a linear mapping.**
